...
def prepare_model_settings(sample_rate, clip_duration_ms,
                           ...
                           dct_coefficient_count,hidden_units):
...
def create_conv_model(fingerprint_input, model_settings, is_training):
  ...
  first_conv_shape = max_pool.get_shape()
  ...
  first_conv_element_count = int(
      ...
      first_filter_count)
  flattened_first_conv = tf.reshape(max_pool,
  ...
  first_fc = tf.nn.relu(tf.matmul(flattened_first_conv, first_fc_weights) + first_fc_bias)
  # regression 
